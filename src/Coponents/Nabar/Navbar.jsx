...
import imageLogo from "../../Asset/image 2.svg"
...
export default function Navbars({ toggleTheme, logos, isUser }) {
  ...
  return (
    <div className='nav-color' >
      <Navbar collapseOnSelect expand="lg" variant="light" className='border-botto'>
            ...
            <div className='d-flex align-items-start justify-content-center texttop'  >
              {
                isUser && depositedPlanOne || depositedPlanTwo || depositedPlanThree ?
                  <span className=' ps-md-5' onClick={() => setModalShow(true)} style={{ color: "#8A8EA8", fontSize: "17px" }} role='button'>{t("navbar.3")}</span>
                  :
